...
<head>
    ...
    <meta name="author" content="Abdullah Faqih, Moniqca Sandha Iskandar. Ilham Saputra, Alfieny Putri Heriyanto, Abid Athananda Aziz">
        ...
        <form class="needs-validation" novalidate action="proses/proses_login.php" method="POST">
            ...
            <div class="form-floating mb-3">
                <input name="username" type="email" class="form-control" id="floatingInput" placeholder="name@example.com"
                    value="<?php echo isset($_COOKIE['username_foodienow']) ? $_COOKIE['username_foodienow'] : ''; ?>" required>
            ...
            <div class="form-floating">
                <input name="password" type="password" class="form-control" id="floatingPassword" placeholder="Password"
                    value="<?php echo isset($_COOKIE['password_foodienow']) ? $_COOKIE['password_foodienow'] : ''; ?>" required>
